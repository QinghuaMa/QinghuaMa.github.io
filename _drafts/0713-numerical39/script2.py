...
fun = lambda x: x**3 - 2*x**2 + (4/3)*x - 8/27
...
# Specify Xtick
xtick_x = [i for i in range(0, 15, 2)]
xtick_L = [i for i in range(0, 15, 2)]
...
axes[0].set_xticks(xtick_x, xtick_L)
...
axes[1].set_xticks(xtick_x, xtick_L)
...
axes[2].set_xticks(xtick_x, xtick_L)
